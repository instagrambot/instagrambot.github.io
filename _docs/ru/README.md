...
* Вы можете найти ответы на наиболее популярные вопросы [здесь](/docs/ru/FAQ).

## Установка

Вы можете прочитать инструкцию по установке Instabot, перейдя по ссылке ниже.
* Установка на [Windows](/docs/ru/Installation_on_Windows),
* Установка на [Unix](/docs/ru/Installation_on_Unix).

## Как пользоваться

Прочитать инструкцию по применению можно [здесь](/docs/ru/How_to_use).
...
Разработчикам лучше почитать [документацию](/docs/en/For_developers).
